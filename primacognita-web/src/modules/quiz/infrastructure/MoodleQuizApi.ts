...
import type { AttemptData, AttemptReviewData, ProcessResult, QuizMeta, UserAttempt } from '../domain/IQuizRepository';
...
export default class MoodleQuizApi implements IQuizApi {
